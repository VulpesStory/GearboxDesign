...
for j = 4:-1:2
   ...
   fprintf("F_n: %4.2d; C: %4.2d; eta: %4.2d; M: %4.2d \n",F_n, C, eta, M);
end
...
% Вид нагрузки на подшипник d = 6 мм; D = 13 мм;
% На внутр кольцо - местное f6 (вал) небольшой зазор
% Предельное отклонение в:0 н:-7
% На внешн кольцо - циркуляционное M7 (корпус) небольшой натяг 
